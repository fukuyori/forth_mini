...
public class Interpreter {
    ...
    public void Execute(string command) {
        var _command = Regex.Replace(command, @"\s+", " ");
...
class Program {
    static void Main(string[] args) {
        ...
        // コンパイルして実行
        compiler.Compile("3 4 + ."); // 出力: 7
        compiler.Compile("10 2 / ."); // 出力: 5
        compiler.Compile("2 3 < ."); // 出力: -1 (true)
        compiler.Compile("3 2 < ."); // 出力: 0 (false)
        compiler.Compile("5 dup * ."); // 出力: 25
    }
} */
